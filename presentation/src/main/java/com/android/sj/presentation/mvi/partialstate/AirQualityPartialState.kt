...
sealed class AirQualityPartialState {
    ...
    data class AirQualityEmpty(val message: String, val code: Int? = null) : AirQualityPartialState()
    ...
    data class RltmStationEmpty(val message: String, val code: Int? = null) : AirQualityPartialState()
    ...
    data class StationFindEmpty(val message: String, val code: Int? = null) : AirQualityPartialState()
}