...
import com.android.sj.common.HTTP_ERROR
import com.android.sj.common.INVALID_REQUEST_PARAMETER_ERROR
import com.android.sj.common.LIMITED_NUMBER_OF_SERVICE_REQUESTS_EXCEEDS_ERROR
import com.android.sj.common.NODATA_ERROR
import com.android.sj.common.NO_MANDATORY_REQUEST_PARAMETERS_ERROR
import com.android.sj.common.NO_OPENAPI_SERVICE_ERROR
import com.android.sj.common.SERVICETIME_OUT
import com.android.sj.common.SERVICE_ACCESS_DENIED_ERROR
import com.android.sj.common.SERVICE_KEY_IS_NOT_REGISTERED_ERROR
import com.android.sj.common.TEMPORARILY_DISABLE_THE_SERVICEKEY_ERROR
import com.android.sj.common.UNREGISTERED_IP_ERROR
import com.android.sj.common.UNSIGNED_CALL_ERROR
import com.android.sj.common.utils.logMessage
import com.android.sj.domain.models.NaverMapData
import com.android.sj.presentation.R
import com.android.sj.presentation.RequestConstants.ADDR
import com.android.sj.presentation.RequestConstants.ROAD_ADDR
...
fun NaverMapData.mapAddressConvert(context: Context): String {
    return when (resultName) {
        ROAD_ADDR -> {
            "$regionArea1Name $regionArea2Name $landName $landNumber"
        }
        ADDR -> {
            "$regionArea1Name $regionArea2Name $regionArea3Name $landNumber"
        }
        else -> {
...
fun Int.dataPotalResultCode(context: Context): String {
    val codeToString = when (this.toString()) {
