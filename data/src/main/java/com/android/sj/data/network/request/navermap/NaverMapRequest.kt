package com.android.sj.data.network.request.navermap

import com.android.sj.data.network.ApiConstants.DATA_TYPE_LOWER
import com.android.sj.data.network.ApiConstants.MAP_CLIENT_KEY
import com.android.sj.data.network.ApiConstants.MAP_CLIENT_KEY_ID
import com.android.sj.data.network.ApiConstants.MAP_COORDINATE_DEFAULT
import com.android.sj.data.network.ApiConstants.MAP_COORDINATE_TM
import com.android.sj.data.network.ApiConstants.MAP_ORDERS
import com.android.sj.data.network.ApiConstants.MAP_REQUEST_DEFAULT
