...
val SearchImageVector: ImageVector
    get() {
        if (_SearchImageVector != null) {
            return _SearchImageVector!!
        }
        _SearchImageVector = ImageVector.Builder(
            name = "Search",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _SearchImageVector: ImageVector? = null

@Preview(showBackground = true)
@Composable
private fun SearchImageVectorPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = SearchImageVector, contentDescription = null)
    }
}
